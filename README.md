...
This is the backend of Energy Watch project which watches the energy consumption of facilities and performs basic CRUD operations with Node.js, MongoDB and PostgreSQL. 
